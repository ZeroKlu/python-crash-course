# Assignment 9.5
# Login Attempts: Add an attribute called login_attempts to your User class from Exercise 9-3. Write a method
#                 called increment_login_attempts() that increments the value of login_attempts by 1.
