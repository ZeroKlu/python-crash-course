...
#        personalized greeting to the user. Create several instances representing different users, and call both
...
user_3 = User("jeremy", "mclean", location = "columbus", profession = "restaurant manager")
user_3.greet()
user_3.describe()
