...
#                   and store each as a value in your dictionary. Print
#                   each person's name and their favorite number. For even
#                   more fun, poll a few friends and get some actual data
#                   for your program.
