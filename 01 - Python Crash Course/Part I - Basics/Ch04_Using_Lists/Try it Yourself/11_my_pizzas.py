...
# My Pizzas, Your Pizzas: Start with your program from Exercise
#                         4-1 (page 56). Make a copy of the list
#                         of pizzas, and call it friend_pizzas.
...
#   and then use a for loop to print the second list. Make sure
