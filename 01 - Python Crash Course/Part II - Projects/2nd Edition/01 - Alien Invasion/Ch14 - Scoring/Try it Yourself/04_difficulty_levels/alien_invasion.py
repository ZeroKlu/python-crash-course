# Assignment 14.4
# Difficulty Levels: Make a set of buttons for Alien Invasion that allows the player to select an
#                    appropriate starting difficulty level for the game. Each button should assign
#                    the appropriate values for the attributes in Settings needed to create different
#                    difficulty levels.
