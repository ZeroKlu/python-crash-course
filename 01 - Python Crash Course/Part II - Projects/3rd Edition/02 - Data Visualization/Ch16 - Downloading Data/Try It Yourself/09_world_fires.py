...
#
#              Using the data processing work from the first part of this chapter and the mapping work from this
#              section, make a map that shows which parts of the world are affected by fires. You can download more
